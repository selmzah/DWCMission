...
service cds.xt.JobsService {
  ...
  @open action enqueue @(requires:[ 'internal-user', 'cds.Subscriber', 'mtcallback' ]) (op: String, @cds.validate: false clusters: array of Set, @cds.validate: false args: array of {}, callback: {}) returns Jobs;
