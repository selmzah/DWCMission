...
const { warn, dim } = require('../../../util/term')
...
module.exports = class TyperTemplate extends require('../../plugin') {
  ...
  async run() {
    ...
    console.log(dim(`  Adding '@cds-models' to .gitignore to ignore generated types`)) // REVISIT: other facets are silent wrt. what they change
    try {
